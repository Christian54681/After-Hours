...
import { GlassWater, Sparkles, Calendar, Star, Menu, ShieldCheck, LogOut, ChevronRight, ChevronLeft } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            ...
            <div className="relative">
                <button
                    onClick={scrollLeft}
                    className="absolute left-6 top-1/2 -translate-y-1/2 z-30 flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-black/40 text-white backdrop-blur-md transition-all hover:bg-primary hover:text-black active:scale-95"
                ...
                <button
                    onClick={scrollRight}
                    className="absolute right-6 top-1/2 -translate-y-1/2 z-30 flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-black/40 text-white backdrop-blur-md transition-all hover:bg-primary hover:text-black active:scale-95"
                    aria-label="Deslizar derecha"
                >
                    <ChevronRight className="w-6 h-6" />
                </button>
                <div ref={scrollRef} className="w-full flex overflow-x-auto snap-x snap-mandatory no-scrollbar gap-8 pb-10">
