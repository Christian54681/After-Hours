                                    ...
                                    <div className="mt-3 flex flex-wrap gap-1.5">
                                        {WEEK_DAYS.map((d) => {
                                            ...
                                            return (
                                                <span
                                                    key={d.key}
                                                    className={`text-xs px-2 py-1 rounded-md border ${active
                                ...
                                {visibleTables.map((t) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`text-left rounded-lg border p-4 transition-all ${isSelected
                                            ...
                                            <div className="mt-2 flex items-center justify-between text-xs text-muted-foreground">
                                                ...
                                                {tableHasOrder(t.id) && (
                                                    <span className="flex items-center gap-1 text-primary">
                                                        <text className="w-3 h-3" /> Pedido activo
                                                    </span>
                                                )}
                                            </div>
                                        </button>
