...
import { intervalsForDay, validateShift } from "@/lib/shiftConflicts";
                                ...
                                {WEEK_DAYS.map((d) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex items-center gap-2 px-3 py-2 rounded-md border text-xs font-medium transition-all ${active
